...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-)8acm#3c#21kse2w@^9z=t^wmssaqbr8z5v+(4j+_eku_o&)_#')
...
DATABASES = {
    'default': dj_database_url.config(
        # Feel free to alter this to connect to your local development database.
...
# Enable WhiteNoise's GZIP compression and other features
